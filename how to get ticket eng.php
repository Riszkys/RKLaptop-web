...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light navbar-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Toko.php" style="color: white">KONSER</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tentang kami.php" style="color: white">TENTANG KAMI</a>
            </li>
  ...
  <section class="ticket">
    <a href="how to get a ticket.php" style="padding-left: 2rem; text-decoration: underline">
      Bahasa Indonesia
      <a href="how to get ticket eng.php" style="padding-left: 1.5rem; text-decoration: underline">
        Bahasa Inggris</a></a>
    <ol>
      <li style="padding-left: 0rem">
        look for our partners closest to your home or where you subscribe
      </li>
      <li style="padding-left: 0rem">Fill out the Promise form as appropriate</li>
      <li style="padding-left: 0rem">
        Fill in all appointment forms without any blanks
      </li>
      <li style="padding-left: 0rem">
        Save the Proof of the Appointment Form to be taken to the Destination Place
      </li>
    </ol>
    <br />
  </section>
