  ...
  <section class="refund-policy">
    <a href="warranty.php" style="padding-left: 2rem; text-decoration: underline">
      ...
      <a href="warranty english.php" style="padding-left: 1.5rem; text-decoration: underline">
        Bahasa Inggris</a></a>
    <li>Make sure you make a prior agreement with our Partner to submit a Warranty Claim</li>
    <li>You can contact our partners via WhatsApp when you fill out the Promise Form</li>
    <li>Make sure the Warranty Claim does not exceed the day limit given by our partners</li>
    <li>
      Warranty claims can be obtained except for damage to human error
    </li>
    <br />
    <h5 style="padding-left: 2rem">Warranty Claims Policy</h5>
    <li>In general, our partners provide a warranty period of only one month</li>
    <li>If it exceeds the deadline, the warranty cannot be claimed</li>
    <li>Must bring a receipt from our partner service place</li>
