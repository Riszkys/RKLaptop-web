...
<body>
  ...
  <section class="faq">
    ...
    <div class="content-faq">
      ...
      <li>Bagaimana cara memiliki akun di RK Laptop?</li>
      <p>
        Anda tinggal mencari button login untuk melakukan registrasi jika belum mempunyai akun
      </p>
      <li>Bagaimana cara melakukan pengisian formulir janjian?</li>
      <p>
        Pilih tempat service tujuan anda lalu isi semua formulir dengan lengkap dan benar tanpa ada yang terkecuali
      </p>
      <li>Bagaimana cara membuat bukti form janji?</li>
      <p>
        pada saat selesai mengisi formulir maka anda bisa menyimpan hasil form tersebut dalam bentuk PDF
      </p>
