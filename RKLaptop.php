...
<body>
        ...
        <div class="form-box login">
          ...
          <form action="" method="POST" class="login-email">
            <div class="input-box">
              ...
              <input type="email" style="color: white" name="email" required />
              <label style="color: white">Email</label>
            </div>
            <div class="input-box">
              <span class="icon"><i class="fa-solid fa-lock" style="color: white"></i></span>
              <input type="password" style="color: white" name="password" required />
            ...
            <button type="submit" name="submit" class="btnLGN" id="btnLogin" style="background-color: white; color: black">
              Login
            </button>
        ...
        <div class="form-box register">
          ...
          <form action="" method="POST" class="login-register">
            <div class="input-box">
              ...
              <input type="text" style="color: white" name="username" required />
            ...
            <button type="submit" name="submit1" class="btnLGN" id="btnRegister" style="background-color: white; color: black">
              Register
            </button>
            <div class="login-register">
              <p style="color: white">
  ...
  <div class="banner-slider">
    <div class="slider">
      <div>
        <a href="#">
          <img src="img\Banner Toko 1.png" alt="image 1" style="width: 500; height: 250" />
        </a>
      </div>
      <div>
        <a href="#">
          <img src="img\Banner Toko 2.png" alt="image 2" style="width: 500; height: 250" />
        </a>
      </div>
      <div>
        <a href="#">
          <img src="img\Banner Toko 3.png" alt="image 3" style="width: 500; height: 250" />
        </a>
      </div>
      <div>
        <a href="#">
          <img src="img\Banner Toko 4.png" alt="image 4" style="width: 500; height: 250" />
        </a>
      </div>
    </div>
  </div>
  ...
  <div id="Testi">
    <section class="testimonials" style="padding-bottom: 50px; color: #1a1a1a">
      <div class="container">
        <h2 style="text-align: center; color: white">Apa Kata Mereka?</h2>
        <div class="row">
          <div class="col-md-4">
            <div class="testimonial">
              <div class="testimonial-image">
                <img src="img/FOTO FORMAL BACKGROUND PUTIH.png" alt="" />
              </div>
              <div class="testimonial-content">
                ...
                <div class="testimonial-meta">- Rendi Ganteng -</div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
  ...
  <section id="contact" style="background-color: #fff; padding: 50px 0">
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <form id="contactForm" method="POST">
            <div class="form-group">
              <label style="font-size: 1.2rem; font-weight: 500; color: #2c3e50">Name</label>
              <input type="text" class="form-control neon-border-gold" placeholder="Name" id="name" required name="nama" />
            </div>
            <div class="form-group">
              <label style="font-size: 1.2rem; font-weight: 500; color: #2c3e50">Email Address</label>
              <input type="email" class="form-control neon-border-gold" placeholder="Email Address" id="email" required name="email" />
            </div>
            <div class="form-group">
              <label style="font-size: 1.2rem; font-weight: 500; color: #2c3e50">Phone Number</label>
              <input type="text" class="form-control neon-border-gold" placeholder="Phone Number" id="phone" required name="nohp" />
            </div>
            <div class="form-group">
              <label style="font-size: 1.2rem; font-weight: 500; color: #2c3e50">Message</label>
              <textarea rows="5" class="form-control neon-border-gold" placeholder="Message" id="message" required name="pesan"></textarea>
            </div>
            <div id="success"></div>
            <button id="submit-btn" class="btn btn-primary btn-xl text-uppercase" type="submit" name="btnhelp" style="
  ...
  <script>
    ...
    form.addEventListener("submit", (event) => {
      ...
      successMsg.innerText = "Thank you for your message!";
      form.reset();
    });
  </script>
  ...
  <script>
    ...
    function setSelectedToko() {
      var selectedToko = document.getElementById("namamitra").innerText;
      document.getElementById("toko").value = selectedToko;
    }
  </script>
