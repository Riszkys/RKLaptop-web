...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light navbar-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline" style="padding-bottom: 1rem">
            <input class="form-control" type="text" placeholder="Cari konser" style="width: 250px" id="search-item" onkeyup="search()" />
  ...
  <section class="faq">
    <a href="faq.php" style="padding-left: 4rem; text-decoration: underline">
      Bahasa Indonesia
      <a href="faq eng.php" style="padding-left: 2rem; text-decoration: underline">
        Bahasa Inggris</a></a>
    <div class="content-faq">
      <h5>Frequently Asked Questions :</h5>
      <li>How do I have an account at RK Laptop?</li>
      <p>All you have to do is look for the login button to register if you don't have an account yet</p>
      <li>How do I fill out the appointment form?</li>
      <p>Choose your destination service, then fill out all the forms completely and correctly without any exceptions</p>
      <li>How do I make a proof of an appointment form?</li>
      <p>
        When finished filling out the form, you can save the results of the form in PDF format
      </p>
      <li>How long is the payment deadline for an order?</li>
      <p>
        The deadline for your order is 1×24 hours, if it exceeds the payment
        deadline your order will be automatically cancelled
      </p>
